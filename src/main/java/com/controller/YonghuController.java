...
//            params.put("yonghuId",request.getSession().getAttribute("userId"));
            ...
            params.put("yuangongRoleTypes111",111);
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        if(yonghu==null || !yonghu.getPassword().equals(password))
         ...
         Map<Integer, String> role_types = dictionaryMap.get("yonghu_role_types");

        String token = tokenService.generateToken(yonghu.getId(),username, "yonghu", role_types.get(yonghu.getYonghuRoleTypes()));
        R r = R.ok();
        r.put("token", token);
        r.put("role",role_types.get(yonghu.getYonghuRoleTypes()));
