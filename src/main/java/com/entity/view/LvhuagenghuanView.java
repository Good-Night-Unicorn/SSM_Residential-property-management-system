...
public class LvhuagenghuanView extends LvhuagenghuanEntity implements Serializable {
	...
	public LvhuagenghuanView() {

	}

	public LvhuagenghuanView(LvhuagenghuanEntity lvhuagenghuanEntity) {
		try {
			BeanUtils.copyProperties(this, lvhuagenghuanEntity);
