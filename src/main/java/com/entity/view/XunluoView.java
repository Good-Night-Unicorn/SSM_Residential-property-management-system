 ...
 */
@TableName("xunluo")
public class XunluoView extends XunluoEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		/**
		* 是否正常的值
		*/
		private String xunluoValue;
	...
	public XunluoView(XunluoEntity xunluoEntity) {
		try {
			BeanUtils.copyProperties(this, xunluoEntity);
			...
			* 获取： 是否正常的值
			*/
			public String getXunluoValue() {
				return xunluoValue;
			}
			/**
			* 设置： 是否正常的值
			*/
			public void setXunluoValue(String xunluoValue) {
				this.xunluoValue = xunluoValue;
			}
