...
<!--/Pre Loader -->
        ...
        <div id="content">
            ...
            <div class="container mt-0">
                <div class="row breadcrumb-bar">
                    <div class="col-md-6">
                        <h3 class="block-title">绿化负责管理</h3>
                    </div>
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">绿化负责管理</li>
                            <li class="breadcrumb-item active">绿化负责列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="widget-area-2 lochana-box-shadow">
                            <h3 class="widget-title">绿化负责列表</h3>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="lvhuafuzeNameSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="负责区域" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //负责区域
            var lvhuafuzeNameSearchInput = $('#lvhuafuzeNameSearch');
            if( lvhuafuzeNameSearchInput != null){
                if (lvhuafuzeNameSearchInput.val() != null && lvhuafuzeNameSearchInput.val() != '') {
                    searchForm.lvhuafuzeName = $('#lvhuafuzeNameSearch').val();
                }
            }
                    getDataList();
        }
        ...
        function getDataList() {
            http("lvhuafuze/page", "GET", {
                page: pageIndex,
                limit: pageSize,
                sort: sortColumn,
                order: sortOrder,
                //本表的
                lvhuafuzeName: searchForm.lvhuafuzeName,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //负责区域
            var lvhuafuzeNameCell = document.createElement('td');
            lvhuafuzeNameCell.innerHTML = item.lvhuafuzeName;
            row.appendChild(lvhuafuzeNameCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("lvhuafuze/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addlvhuafuze", "addlvhuafuze");
            window.location.href = "add-or-update.jsp"
        }
