                    ...
                    <div class="widget-area-2 lochana-box-shadow">
                        ...
                        <form id="addOrUpdateForm">
                            ...
                            <!-- 当前表的字段 -->
                                    ...
                                    <div class="form-group col-md-6">
                                        <label>权限</label>
                                        <select id="yonghuRoleTypesSelect" name="yonghuRoleTypes" class="form-control">
                                        </select>
                                    </div>
...
<script>
    ...
    // 查询列表
        ...
        function yonghuRoleTypesSelect() {
            //填充下拉框选项
            http("dictionary/page?page=1&limit=100&sort=&order=&dicCode=yonghu_role_types", "GET", {}, (res) => {
                if(res.code == 0){
                    yonghuRoleTypesOptions = res.data.list;
                }
            });
        }
        <!-- 查询级联表的所有列表 -->
    ...
    <!-- 初始化当前表的下拉框 -->
        ...
        function initializationYonghuroletypesSelect(){
            var yonghuRoleTypesSelect = document.getElementById('yonghuRoleTypesSelect');
            if(yonghuRoleTypesSelect != null && yonghuRoleTypesOptions != null  && yonghuRoleTypesOptions.length > 0 ){
                for (var i = 0; i < yonghuRoleTypesOptions.length; i++) {
                    yonghuRoleTypesSelect.add(new Option(yonghuRoleTypesOptions[i].indexName,yonghuRoleTypesOptions[i].codeIndex));
                }
            }
        }
    ...
    function setSelectOption() {
        ...
        if(yonghuRoleTypesSelect != null && yonghuRoleTypesOptions != null  && yonghuRoleTypesOptions.length > 0 ) {
            for (var i = 0; i < yonghuRoleTypesOptions.length; i++) {
                if (yonghuRoleTypesOptions[i].codeIndex == ruleForm.yonghuRoleTypes) {//下拉框value对比,如果一致就赋值汉字
                        yonghuRoleTypesSelect.options[i].selected = true;
                }
            }
        }
        <!--  级联表的下拉框回显  -->
    ...
    $(document).ready(function () {
        ...
        // 初始化下拉框
            ...
            initializationYonghuroletypesSelect();
            <!--  初始化级联表的下拉框  -->
    ...
    function readonly() {
        if (window.sessionStorage.getItem('role') == '管理员') {
            ...
            $('#yonghuRoleTypesSelect').attr('readonly', 'readonly');
            $('#yonghuRoleTypesSelect').attr('style', 'pointer-events: none;');
        }
    }
