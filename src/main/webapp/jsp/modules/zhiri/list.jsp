...
<!--/Pre Loader -->
                ...
                <div class="row breadcrumb-bar">
                    ...
                    <div class="col-md-6">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">值日列表</li>
                        </ol>
                    </div>
                </div>
            </div>
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <div class="layui-inline" style="margin-bottom: 10px;">
                                        ...
                                        <div class="layui-input-inline">
                                            <input type="text" id="zhiriTimeSearch" style="width: 140px;" class="form-control form-control-sm"
                                                   placeholder="值日日期" aria-controls="tableId">
                                        </div>
                                    </div>
    ...
    <script>
        ...
        <!-- 级联表的级联字典表 -->
            ...
            //值日日期
            var zhiriTimeSearchInput = $('#zhiriTimeSearch');
            if( zhiriTimeSearchInput != null){
                if (zhiriTimeSearchInput.val() != null && zhiriTimeSearchInput.val() != '') {
                    searchForm.zhiriTime = $('#zhiriTimeSearch').val();
                }
            }
                        getDataList();
        }
        ...
        function getDataList() {
            http("zhiri/page", "GET", {
                ...
                order: sortOrder,
                //本表的
                zhiriTime: searchForm.zhiriTime,
            //级联表的
        ...
        function setDataRow(item, number) {
            ...
            //值日日期
            var zhiriTimeCell = document.createElement('td');
            zhiriTimeCell.innerHTML = item.zhiriTime;
            row.appendChild(zhiriTimeCell);


                //备注
            var zhiriContentCell = document.createElement('td');
            //如果图文详情包含图片
            if (item.zhiriContent && item.zhiriContent.indexOf('img') != -1) {
                //暂时只考虑图片+文字 和 文字+图片的情况
                var beginIndex = item.zhiriContent.indexOf('<img');
                var endIndex = item.zhiriContent.indexOf('>');
                    zhiriContentCell.innerHTML = item.zhiriContent.substring(beginIndex, endIndex + 1).replace("img", "img width='100' height='100'");
            } else {
                if (item.zhiriContent != null && item.zhiriContent != "" && item.zhiriContent.length >= 11) {
                        zhiriContentCell.innerHTML = item.zhiriContent.substring(0, 10) + "...";
                } else {
                        zhiriContentCell.innerHTML = item.zhiriContent;
                }
            }
            row.appendChild(zhiriContentCell);
        ...
        function remove(id) {
            ...
            if (mymessage == true) {
                ...
                httpJson("zhiri/delete", "POST", paramArray, (res) => {
                    if(res.code == 0){
                        getDataList();
                        alert('删除成功');
                    }
        ...
        //添加
        function add() {
            window.sessionStorage.setItem("addzhiri", "addzhiri");
            window.location.href = "add-or-update.jsp"
        }
