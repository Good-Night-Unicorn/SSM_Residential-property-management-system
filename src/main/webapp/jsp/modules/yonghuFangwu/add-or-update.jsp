    ...
    <div id="content">
        ...
        <div class="container mt-0">
            <div class="row breadcrumb-bar">
                <div class="col-md-6">
                    <h3 class="block-title">编辑房屋登记</h3>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item">房屋登记管理</li>
                        <li class="breadcrumb-item active">编辑房屋登记</li>
                    </ol>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="widget-area-2 lochana-box-shadow">
                        <h3 class="widget-title">房屋登记信息</h3>
                        <form id="addOrUpdateForm">
                            <div class="form-row">
                            <!-- 级联表的字段 -->
                                    <div class="form-group col-md-6 aaaaaa fangwu">
                                        <label>房屋</label>
                                        <div>
                                    ...
                                    <div class="form-group col-md-6 fangwu">
                                        <label>楼栋</label>
...
<script>
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            if(window.sessionStorage.getItem('role') != '房屋'){//当前登录用户不为这个
                if($("#fangwuId") !=null){
            ...
            httpJson("yonghuFangwu/" + urlParam, "POST", data, (res) => {
                if(res.code == 0){
                    window.sessionStorage.removeItem('addyonghuFangwu');
    ...
    // 查询列表
        ...
        function yonghuSelect() {
            //填充下拉框选项
            http("yonghu/page?page=1&limit=100&sort=&order=&yuangongRoleTypes111=111", "GET", {}, (res) => {
                if(res.code == 0){
        ...
        function initializationfangwuSelect() {
            ...
            if(fangwuSelect != null && fangwuOptions != null  && fangwuOptions.length > 0 ) {
                for (var i = 0; i < fangwuOptions.length; i++) {
                        fangwuSelect.add(new Option("楼栋:"+fangwuOptions[i].building+"单元:"+fangwuOptions[i].unit+"房间:"+fangwuOptions[i].room, fangwuOptions[i].id));
                }
    ...
    // 获取当前详情
    function getDetails() {
        var addyonghuFangwu = window.sessionStorage.getItem("addyonghuFangwu");
        if (addyonghuFangwu != null && addyonghuFangwu != "" && addyonghuFangwu != "null") {
            //注册表单验证
            $(validform());
            $('#submitBtn').text('新增');
            ...
            window.sessionStorage.removeItem('updateId');
            http("yonghuFangwu/info/" + updateId, "GET", {}, (res) => {
                if(res.code == 0)
                {
                    ruleForm = res.data
                    // 是/否下拉框回显
