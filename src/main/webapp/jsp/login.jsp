        ...
        <form id="loginForm" action="" method="post" class="form">
            ...
            <div class="body-content">
				...
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="业主" onclick="checkRole('yonghu')">&nbsp;业主
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="租户" onclick="checkRole('yonghu')">&nbsp;租户
                        </label>
                    </div>
                </div>
				<div class="form-group">
                    <div class="checkbox-list">
                        <label>
                            <input type="radio" name="chk" value="保安" onclick="checkRole('yonghu')">&nbsp;保安
                        </label>
                    </div>
                </div>
				<div class="form-group">
